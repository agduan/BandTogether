...
describe('keyboard injector', () => {
  it('n and m pluck the bass down and up', () => {
    const seen: AppEvent[] = [];
    ...
    off();
    expect(seen).toEqual([
      { type: 'bass.pluck', t: 10, playerId: 0, direction: 'down', velocity: 0.8, pitchBin: null },
      { type: 'bass.pluck', t: 20, playerId: 0, direction: 'up', velocity: 0.6, pitchBin: null },
    ]);
  });
